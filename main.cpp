...
int main(int argc, char **argv)
{
    ...
    // move("fs-case9.bin", "/dec7556/t2.txt", "/t2.txt");          // Funciona MEIA BOCA
    // move("fs-case10.bin", "/teste.txt", "/dec7556/teste.txt");   // NÃO FUNCIONA
    // move("fs-case12.bin", "/b.txt", "/a.txt");                   // Funciona
    return 0;
}